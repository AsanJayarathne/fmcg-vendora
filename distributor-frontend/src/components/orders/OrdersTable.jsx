                ...
                return (
                  <tr key={order.order_id} className="hover:bg-slate-50/60 transition duration-150">
                    ...
                    <td className="px-6 py-4 font-semibold text-slate-600">
                      <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${order.payment_method === "Cash" ? "bg-green-50 text-green-700 border border-green-200/50" :
