        ...
        <div className="flex items-center justify-between mb-5">
          <div>
            <h2 className="font-semibold text-slate-800 text-base leading-tight">
              {t("analytics.mostOrderedProducts", "Most Ordered Products")}
            </h2>
            <p className="text-xs text-slate-400 font-normal mt-0.5">
              {t("analytics.volumeDistribution", "Volume distribution across top items")}
            </p>
          </div>
          <span className="rounded-full bg-blue-50 border border-blue-100 px-3 py-1 text-blue-600 text-xs font-medium">
            {t("analytics.topDemand", "Top Demand")}
          </span>
        </div>
            ...
            return (
              <div key={product.name}>
                <div className="flex justify-between items-center text-xs mb-1.5 font-medium">
                  ...
                  <span className="text-slate-500">{product.value} {t("analytics.units", "units")}</span>
                </div>
