    ...
    <div className="h-full bg-white p-6 rounded-3xl border border-slate-100 shadow-xs flex flex-col justify-between">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 font-normal mt-0.5">Payment breakdown collected today</p>
        </div>
      ...
      <div className="mt-6 space-y-3 flex-1 flex flex-col justify-center">
        <div className="rounded-2xl bg-blue-50/40 border border-blue-100/50 p-4">
          <p className="text-[10px] font-semibold text-blue-600/70 uppercase tracking-wider mb-1">Total</p>
          <p className="text-xl font-bold text-blue-700">Rs. {fmt(computedTotal)}</p>
        </div>
        <div className="rounded-2xl bg-green-50/40 border border-green-100/50 p-4">
          <p className="text-[10px] font-semibold text-green-600/70 uppercase tracking-wider mb-1">Cash</p>
          <p className="text-lg font-bold text-green-700">Rs. {fmt(cashAmount)}</p>
        </div>
        <div className="rounded-2xl bg-amber-50/40 border border-amber-100/50 p-4">
          <p className="text-[10px] font-semibold text-amber-600/70 uppercase tracking-wider mb-1">Credit</p>
          <p className="text-lg font-bold text-amber-700">Rs. {fmt(creditAmount)}</p>
        </div>
      </div>
    </div>
  );
