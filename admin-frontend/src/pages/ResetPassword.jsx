...
export default function ResetPassword() {
  ...
  useEffect(() => {
    if (!token || !email) {
      ...
      setError("Missing reset token or email in the link.");
      return;
    }
      ...
      <div className="relative w-full max-w-lg z-10">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 sm:p-10 text-white">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-extrabold text-white">Reset Admin Password</h1>
            <p className="text-xs text-blue-200/70 mt-1">
              Admin Account: <span className="font-semibold text-white">{email || "your account"}</span>
            </p>
          </div>
          ...
          {verifying && (
            <div className="py-12 text-center">
              ...
              <p className="text-sm font-semibold text-slate-300">Verifying reset token...</p>
            </div>
          )}
          ...
          {!verifying && isTokenValid && success && (
            <div className="text-center py-6">
              ...
              <p className="text-sm text-slate-300 mt-2">
                Your admin password has been changed. Old sessions have been invalidated.
              </p>
